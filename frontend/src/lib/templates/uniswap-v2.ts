...
export const uniswapV2Template: TemplateFile[] = [
  {
    id: 'uniswap-v2-pair',
...
contract UniswapV2Pair is ERC20, Ownable {
    ...
    uint public constant MINIMUM_LIQUIDITY_LAST = 100;
    ...
    function burn(address to) external returns (uint amount0, uint amount1) {
        ...
        (uint112 _reserve0New, uint112 _reserve1New,) = getReserves();
        _update(balance0, balance1, _reserve0New, _reserve1New);
        if (feeOn) kLast = uint(reserve0) * uint(reserve1);
...
contract UniswapV2Factory is Ownable {
  ...
  },
  {
    ...
    path: 'contracts/UniswapV2Router02.sol',
    content: `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function addLiquidityETH(
        ...
        (amountToken, amountETH) = _calculateLiquidityETH(
            token,
            amountTokenDesired,
            msg.value,
            amountTokenMin,
    ...
    function _calculateLiquidity(
        ...
        if (amountADesired * amountBMin <= amountBDesired * amountAMin) {
            amountA = amountADesired;
            amountB = amountADesired * amountBMin / amountAMin;
        } else {
            amountB = amountBDesired;
            amountA = amountBDesired * amountAMin / amountBMin;
        }
    }
    ...
    function _calculateLiquidityETH(
        ...
        if (reserveToken == 0 && reserveETH == 0) {
            ...
            if (amountETHOptimal <= amountETHDesired) {
                ...
                uint amountTokenOptimal = UniswapV2Library.quote(amountETHDesired, reserveETH, reserveToken);
