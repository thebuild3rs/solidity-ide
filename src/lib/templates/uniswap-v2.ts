...
export const uniswapV2Template: FileSystemNode[] = [
  {
    id: 'contracts',
    name: 'contracts',
    type: 'directory',
    ...
    children: [
      {
        ...
        children: [
          {
            id: 'IUniswapV2Factory',
            name: 'IUniswapV2Factory.sol',
            type: 'file',
            path: '/contracts/interfaces/IUniswapV2Factory.sol',
            extension: '.sol',
...
interface IUniswapV2Factory {
    ...
    function setFeeToSetter(address) external;
          ...
          },
          {
            ...
            type: 'file',
            path: '/contracts/interfaces/IUniswapV2Pair.sol',
            extension: '.sol',
            content: `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
...
interface IUniswapV2Pair {
    ...
    function initialize(address, address) external;
      ...
      },
      {
        ...
        type: 'file',
        path: '/contracts/UniswapV2Factory.sol',
        extension: '.sol',
        content: `// SPDX-License-Identifier: MIT
pragma solidity ^0.8.20;
...
contract UniswapV2Pair is IUniswapV2Pair, ERC20 {
  ...
  },
  {
    ...
    children: [
      {
        id: 'UniswapV2Factory.test',
        name: 'UniswapV2Factory.test.ts',
        type: 'file',
        path: '/test/UniswapV2Factory.test.ts',
        extension: '.ts',
...
describe("UniswapV2Factory", function () {
  ...
  it("deploys with correct fee setter", async function () {
    expect(await factory.feeToSetter()).to.equal(await owner.getAddress());
  });

  it("creates pair with correct tokens", async function () {
  ...
  it("reverts when creating pair with identical tokens", async function () {
    await expect(
      factory.createPair(token0.address, token0.address)
    ).to.be.revertedWith("UniswapV2: IDENTICAL_ADDRESSES");
  });

  it("reverts when creating pair with zero address", async function () {
    await expect(
      factory.createPair(token0.address, ethers.constants.AddressZero)
    ).to.be.revertedWith("UniswapV2: ZERO_ADDRESS");
  });

  it("reverts when creating existing pair", async function () {
    await factory.createPair(token0.address, token1.address);
    await expect(
